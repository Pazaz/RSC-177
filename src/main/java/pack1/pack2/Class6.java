...
public class Class6
{
    ...
    public Class6(Class3 class3, int i, int j, int k)
    {
        anInt242 = 50;
        ...
        aBoolean257 = false;
        anInt261 = 100;
        aClass2Array262 = new Class2[anInt261];
        ...
        aBoolean315 = false;
        aClass3_304 = class3;
        anInt265 = class3.anInt184 / 2;
        anInt266 = class3.anInt185 / 2;
        anIntArray305 = class3.anIntArray190;
        anInt277 = 0;
        anInt278 = i;
        aClass2Array279 = new Class2[anInt278];
        anIntArray280 = new int[anInt278];
        anInt281 = 0;
        aClass4Array282 = new Class4[j];
        for(int l = 0; l < j; l++)
            aClass4Array282[l] = new Class4();

        anInt283 = 0;
        aClass2_291 = new Class2(k * 2, k);
    ...
    public void method259(Class2 class2)
    {
        if(class2 == null)
        ...
        if(anInt277 < anInt278)
        {
            ...
            aClass2Array279[anInt277++] = class2;
        }
    }

    public void method260(Class2 class2)
    {
        for(int i = 0; i < anInt277; i++)
            if(aClass2Array279[i] == class2)
            {
                anInt277--;
                for(int j = i; j < anInt277; j++)
                {
                    aClass2Array279[j] = aClass2Array279[j + 1];
    ...
    {
        anInt283 = 0;
        aClass2_291.method175();
    }

    public void method263(int i)
    {
        anInt283 -= i;
        aClass2_291.method176(i, i * 2);
        if(anInt283 < 0)
            anInt283 = 0;
    }
    ...
    public int method264(int i, int j, int k, int l, int i1, int j1, int k1)
    {
        ...
        int l1 = aClass2_291.method179(j, k, l);
        int i2 = aClass2_291.method179(j, k - j1, l);
        int ai[] = {
            l1, i2
        };
        aClass2_291.method180(2, ai, 0, 0);
        aClass2_291.anIntArray131[anInt283] = k1;
        aClass2_291.aByteArray132[anInt283++] = 0;
        return anInt283 - 1;
    }

    public void method265(int i)
    {
        aClass2_291.aByteArray132[i] = 1;
    }
    ...
    public void method271(int i, int j, int k, int l, int i1, int j1)
    {
        ...
        anInt264 = i1;
        anInt269 = j1;
        aClass5Array306 = new Class5[l + j];
        for(int k1 = 0; k1 < l + j; k1++)
            aClass5Array306[k1] = new Class5();

    }

    public void method272(Class4 aclass4[], int i, int j)
    {
        if(i < j)
        {
            int k = i - 1;
            int l = j + 1;
            int i1 = (i + j) / 2;
            Class4 class4 = aclass4[i1];
            aclass4[i1] = aclass4[i];
            aclass4[i] = class4;
            int j1 = class4.anInt229;
            while(k < l) 
            {
                do
                    l--;
    ...
    public void method273(int i, Class4 aclass4[], int j)
    {
        for(int k = 0; k <= j; k++)
        {
        ...
        do
        {
            ...
            if(l == j)
                return;
            Class4 class4 = aclass4[l];
            class4.aBoolean235 = true;
            int i1 = l;
            int j1 = l + i;
            if(j1 >= j)
                j1 = j - 1;
            ...
            {
                Class4 class4_1 = aclass4[k1];
                if(class4.anInt221 < class4_1.anInt223 && class4_1.anInt221 < class4.anInt223 && class4.anInt222 < class4_1.anInt224 && class4_1.anInt222 < class4.anInt224 && class4.anInt236 != class4_1.anInt237 && !method291(class4, class4_1) && method292(class4_1, class4))
                {
                    method274(aclass4, i1, k1);
                    if(aclass4[k1] != class4_1)
                        k1++;
                    i1 = anInt322;
                    class4_1.anInt237 = class4.anInt236;
                }
            }
    ...
    public boolean method274(Class4 aclass4[], int i, int j)
    {
        do
        {
            Class4 class4 = aclass4[i];
            for(int k = i + 1; k <= j; k++)
            {
                Class4 class4_1 = aclass4[k];
                if(!method291(class4_1, class4))
                    break;
                aclass4[i] = class4_1;
                aclass4[k] = class4;
                i = k;
            ...
            Class4 class4_2 = aclass4[j];
            for(int l = j - 1; l >= i; l--)
            {
                Class4 class4_3 = aclass4[l];
                if(!method291(class4_2, class4_3))
                    break;
                aclass4[j] = class4_3;
                aclass4[l] = class4_2;
                j = l;
    ...
    {
        aBoolean315 = aClass3_304.aBoolean208;
        ...
        anInt320 += anInt273;
        anInt321 += anInt273;
        aClass2Array279[anInt277] = aClass2_291;
        aClass2_291.anInt119 = 2;
        for(int i = 0; i < anInt277; i++)
            aClass2Array279[i].method200(anInt271, anInt272, anInt273, anInt274, anInt275, anInt276, anInt269, anInt247);

        aClass2Array279[anInt277].method200(anInt271, anInt272, anInt273, anInt274, anInt275, anInt276, anInt269, anInt247);
        anInt281 = 0;
        for(int k3 = 0; k3 < anInt277; k3++)
        {
            Class2 class2 = aClass2Array279[k3];
            if(class2.aBoolean120)
            {
                for(int j = 0; j < class2.anInt107; j++)
                {
                    int l3 = class2.anIntArray108[j];
                    int ai1[] = class2.anIntArrayArray109[j];
                    boolean flag = false;
                    for(int k4 = 0; k4 < l3; k4++)
                    {
                        int i1 = class2.anIntArray102[ai1[k4]];
                    ...
                    if(flag)
                    {
                        ...
                        {
                            int j1 = class2.anIntArray103[ai1[k5]];
                            if(j1 > -anInt265)
                                l1 |= 1;
                            if(j1 < anInt265)
                                l1 |= 2;
                        ...
                        if(l1 == 3)
                        {
                            ...
                            {
                                int k1 = class2.anIntArray104[ai1[l6]];
                                if(k1 > -anInt266)
                                    i2 |= 1;
                                if(k1 < anInt266)
                                    i2 |= 2;
                            ...
                            if(i2 == 3)
                            {
                                Class4 class4_1 = aClass4Array282[anInt281];
                                class4_1.aClass2_227 = class2;
                                class4_1.anInt228 = j;
                                method289(anInt281);
                                int l8;
                                if(class4_1.anInt233 < 0)
                                    l8 = class2.anIntArray110[j];
                                else
                                    l8 = class2.anIntArray111[j];
                                if(l8 != 0xbc614e)
                                {
                                    int j2 = 0;
                                    for(int l9 = 0; l9 < l3; l9++)
                                        j2 += class2.anIntArray102[ai1[l9]];

                                    int l2;
                                    class4_1.anInt229 = l2 = j2 / l3 + class2.anInt118;
                                    class4_1.anInt234 = l8;
                                    anInt281++;
                                }
                            }
                        }
        ...
        Class2 class2_1 = aClass2_291;
        if(class2_1.aBoolean120)
        {
            for(int k = 0; k < class2_1.anInt107; k++)
            {
                int ai[] = class2_1.anIntArrayArray109[k];
                int j4 = ai[0];
                int l4 = class2_1.anIntArray103[j4];
                int l5 = class2_1.anIntArray104[j4];
                int i7 = class2_1.anIntArray102[j4];
                if(i7 > anInt247 && i7 < anInt249)
                {
                    ...
                    {
                        Class4 class4_2 = aClass4Array282[anInt281];
                        class4_2.aClass2_227 = class2_1;
                        class4_2.anInt228 = k;
                        method290(anInt281);
                        class4_2.anInt229 = (i7 + class2_1.anIntArray102[ai[1]]) / 2;
                        anInt281++;
                    }
                }
            }
        ...
        if(anInt281 == 0)
            return;
        anInt246 = anInt281;
        method272(aClass4Array282, 0, anInt281 - 1);
        method273(100, aClass4Array282, anInt281);
        for(int i4 = 0; i4 < anInt281; i4++)
        {
            Class4 class4 = aClass4Array282[i4];
            Class2 class2_2 = class4.aClass2_227;
            int l = class4.anInt228;
            if(class2_2 == aClass2_291)
            {
                int ai2[] = class2_2.anIntArrayArray109[l];
                int i6 = ai2[0];
                int j7 = class2_2.anIntArray103[i6];
                int j8 = class2_2.anIntArray104[i6];
                int j9 = class2_2.anIntArray102[i6];
                int i10 = (anIntArray288[l] << anInt269) / j9;
                int k10 = (anIntArray289[l] << anInt269) / j9;
                int i11 = j8 - class2_2.anIntArray104[ai2[1]];
                int j11 = ((class2_2.anIntArray103[ai2[1]] - j7) * i11) / k10;
                j11 = class2_2.anIntArray103[ai2[1]] - j7;
                int l11 = j7 - i10 / 2;
                int j12 = (anInt268 + j8) - k10;
                aClass3_304.method244(l11 + anInt267, j12, i10, k10, anIntArray284[l], j11, (256 << anInt269) / j9);
                if(aBoolean257 && anInt260 < anInt261)
                {
                    l11 += (anIntArray290[l] << anInt269) / j9;
                    if(anInt259 >= j12 && anInt259 <= j12 + k10 && anInt258 >= l11 && anInt258 <= l11 + i10 && !class2_2.aBoolean136 && class2_2.aByteArray132[l] == 0)
                    {
                        aClass2Array262[anInt260] = class2_2;
            ...
            } else
            {
                int k8 = 0;
                int j10 = 0;
                int l10 = class2_2.anIntArray108[l];
                int ai3[] = class2_2.anIntArrayArray109[l];
                if(class2_2.anIntArray114[l] != 0xbc614e)
                    if(class4.anInt233 < 0)
                        j10 = class2_2.anInt181 - class2_2.anIntArray114[l];
                    else
                        j10 = class2_2.anInt181 + class2_2.anIntArray114[l];
                for(int k11 = 0; k11 < l10; k11++)
                {
                    int k2 = ai3[k11];
                    anIntArray312[k11] = class2_2.anIntArray100[k2];
                    anIntArray313[k11] = class2_2.anIntArray101[k2];
                    anIntArray314[k11] = class2_2.anIntArray102[k2];
                    if(class2_2.anIntArray114[l] == 0xbc614e)
                        if(class4.anInt233 < 0)
                            j10 = (class2_2.anInt181 - class2_2.anIntArray105[k2]) + class2_2.aByteArray106[k2];
                        else
                            j10 = class2_2.anInt181 + class2_2.anIntArray105[k2] + class2_2.aByteArray106[k2];
                    if(class2_2.anIntArray102[k2] >= anInt247)
                    {
                        anIntArray309[k8] = class2_2.anIntArray103[k2];
                        anIntArray310[k8] = class2_2.anIntArray104[k2];
                        anIntArray311[k8] = j10;
                        if(class2_2.anIntArray102[k2] > anInt251)
                            anIntArray311[k8] += (class2_2.anIntArray102[k2] - anInt251) / anInt250;
                        k8++;
                    } else
                    {
                        int k9;
                        if(k11 == 0)
                            ...
                            k9 = ai3[k11 - 1];
                        if(class2_2.anIntArray102[k9] >= anInt247)
                        {
                            int k7 = class2_2.anIntArray102[k2] - class2_2.anIntArray102[k9];
                            int i5 = class2_2.anIntArray100[k2] - ((class2_2.anIntArray100[k2] - class2_2.anIntArray100[k9]) * (class2_2.anIntArray102[k2] - anInt247)) / k7;
                            int j6 = class2_2.anIntArray101[k2] - ((class2_2.anIntArray101[k2] - class2_2.anIntArray101[k9]) * (class2_2.anIntArray102[k2] - anInt247)) / k7;
                        ...
                        if(class2_2.anIntArray102[k9] >= anInt247)
                        {
                            int l7 = class2_2.anIntArray102[k2] - class2_2.anIntArray102[k9];
                            int j5 = class2_2.anIntArray100[k2] - ((class2_2.anIntArray100[k2] - class2_2.anIntArray100[k9]) * (class2_2.anIntArray102[k2] - anInt247)) / l7;
                            int k6 = class2_2.anIntArray101[k2] - ((class2_2.anIntArray101[k2] - class2_2.anIntArray101[k9]) * (class2_2.anIntArray102[k2] - anInt247)) / l7;
                ...
                for(int i12 = 0; i12 < l10; i12++)
                {
                    ...
                    if(anIntArray311[i12] > 255)
                        anIntArray311[i12] = 255;
                    if(class4.anInt234 >= 0)
                        if(anIntArray295[class4.anInt234] == 1)
                            anIntArray311[i12] <<= 9;
                        else
                            anIntArray311[i12] <<= 6;
                }

                method277(0, 0, 0, 0, k8, anIntArray309, anIntArray310, anIntArray311, class2_2, l);
                if(anInt308 > anInt307)
                    method278(0, 0, l10, anIntArray312, anIntArray313, anIntArray314, class4.anInt234, class2_2);
            }
        }
            ...
            int ai2[], Class2 class2, int j1)
    {
        if(i1 == 3)
        {
            ...
            for(k = anInt307; k < anInt308; k++)
            {
                ...
                Class5 class5_6 = aClass5Array306[k];
                class5_6.anInt238 = i;
                class5_6.anInt239 = j;
                class5_6.anInt240 = l;
                class5_6.anInt241 = l21;
            }
        ...
        if(i1 == 4)
        {
            ...
            for(k = anInt307; k < anInt308; k++)
            {
                ...
                Class5 class5_7 = aClass5Array306[k];
                class5_7.anInt238 = i;
                class5_7.anInt239 = j;
                class5_7.anInt240 = l;
                class5_7.anInt241 = j24;
            }
        ...
        } else
        {
            ...
            for(k = anInt307; k < anInt308; k++)
            {
                Class5 class5 = aClass5Array306[k];
                class5.anInt238 = 0xa0000;
                class5.anInt239 = 0xfff60000;
            }
            ...
            if(i3 < i4)
            {
                ...
                for(k = i3; k <= i4; k++)
                {
                    Class5 class5_2 = aClass5Array306[k];
                    class5_2.anInt238 = class5_2.anInt239 = i5;
                    class5_2.anInt240 = class5_2.anInt241 = l7;
                    i5 += j6;
                    l7 += j9;
                }
            ...
            if(i3 > i4)
            {
                ...
                for(k = i4; k <= i3; k++)
                {
                    Class5 class5_3 = aClass5Array306[k];
                    class5_3.anInt238 = class5_3.anInt239 = j5;
                    class5_3.anInt240 = class5_3.anInt241 = i8;
                    j5 += k6;
                    i8 += k9;
                }
            ...
            for(k = 0; k < j2; k++)
            {
                ...
                if(j3 < j4)
                {
                    ...
                    {
                        Class5 class5_4 = aClass5Array306[l11];
                        if(l6 < class5_4.anInt238)
                        {
                            class5_4.anInt238 = l6;
                            class5_4.anInt240 = l9;
                        }
                        if(l6 > class5_4.anInt239)
                        {
                            class5_4.anInt239 = l6;
                            class5_4.anInt241 = l9;
                        }
                        l6 += j8;
                        l9 += l10;
                    }
                ...
                if(j3 > j4)
                {
                    ...
                    {
                        Class5 class5_5 = aClass5Array306[i12];
                        if(i7 < class5_5.anInt238)
                        {
                            class5_5.anInt238 = i7;
                            class5_5.anInt240 = i10;
                        }
                        if(i7 > class5_5.anInt239)
                        {
                            class5_5.anInt239 = i7;
                            class5_5.anInt241 = i10;
                        }
                        i7 += k8;
                        i10 += i11;
                    }
        ...
        {
            Class5 class5_1 = aClass5Array306[anInt259];
            if(anInt258 >= class5_1.anInt238 >> 8 && anInt258 <= class5_1.anInt239 >> 8 && class5_1.anInt238 <= class5_1.anInt239 && !class2.aBoolean136 && class2.aByteArray132[j1] == 0)
            {
                aClass2Array262[anInt260] = class2;
            ...
            Class2 class2)
    {
        ...
        if(l >= 0)
        {
            ...
            if(anIntArray295[l] == 1)
            {
                ...
                if(class2.aBoolean128)
                {
                    for(i = anInt307; i < anInt308; i += byte1)
                    {
                        Class5 class5_3 = aClass5Array306[i];
                        j = class5_3.anInt238 >> 8;
                        int k17 = class5_3.anInt239 >> 8;
                        int k20 = k17 - j;
                        if(k20 <= 0)
                        {
                            l9 += i11;
                        ...
                        {
                            int i22 = class5_3.anInt240;
                            int k23 = (class5_3.anInt241 - i22) / k20;
                            if(j < -anInt265)
                            {
                                i22 += (-anInt265 - j) * k23;
                                j = -anInt265;
                ...
                if(!aBooleanArray298[l])
                {
                    for(i = anInt307; i < anInt308; i += byte1)
                    {
                        Class5 class5_4 = aClass5Array306[i];
                        j = class5_4.anInt238 >> 8;
                        int i18 = class5_4.anInt239 >> 8;
                        int l20 = i18 - j;
                        if(l20 <= 0)
                        {
                            l9 += i11;
                        ...
                        {
                            int j22 = class5_4.anInt240;
                            int l23 = (class5_4.anInt241 - j22) / l20;
                            if(j < -anInt265)
                            {
                                j22 += (-anInt265 - j) * l23;
                                j = -anInt265;
                ...
                for(i = anInt307; i < anInt308; i += byte1)
                {
                    Class5 class5_5 = aClass5Array306[i];
                    j = class5_5.anInt238 >> 8;
                    int k18 = class5_5.anInt239 >> 8;
                    int i21 = k18 - j;
                    if(i21 <= 0)
                    {
                        l9 += i11;
                    ...
                    {
                        int k22 = class5_5.anInt240;
                        int i24 = (class5_5.anInt241 - k22) / i21;
                        if(j < -anInt265)
                        {
                            k22 += (-anInt265 - j) * i24;
                            j = -anInt265;
            ...
            if(class2.aBoolean128)
            {
                ...
                {
                    Class5 class5_6 = aClass5Array306[i];
                    j = class5_6.anInt238 >> 8;
                    int i19 = class5_6.anInt239 >> 8;
                    int j21 = i19 - j;
                    if(j21 <= 0)
                    {
                        i10 += j11;
                    ...
                    {
                        int l22 = class5_6.anInt240;
                        int j24 = (class5_6.anInt241 - l22) / j21;
                        if(j < -anInt265)
                        {
                            l22 += (-anInt265 - j) * j24;
                            j = -anInt265;
            ...
            if(!aBooleanArray298[l])
            {
                for(i = anInt307; i < anInt308; i += byte2)
                {
                    Class5 class5_7 = aClass5Array306[i];
                    j = class5_7.anInt238 >> 8;
                    int k19 = class5_7.anInt239 >> 8;
                    int k21 = k19 - j;
                    if(k21 <= 0)
                    {
                        i10 += j11;
                    ...
                    {
                        int i23 = class5_7.anInt240;
                        int k24 = (class5_7.anInt241 - i23) / k21;
                        if(j < -anInt265)
                        {
                            i23 += (-anInt265 - j) * k24;
                            j = -anInt265;
            ...
            for(i = anInt307; i < anInt308; i += byte2)
            {
                Class5 class5_8 = aClass5Array306[i];
                j = class5_8.anInt238 >> 8;
                int i20 = class5_8.anInt239 >> 8;
                int l21 = i20 - j;
                if(l21 <= 0)
                {
                    i10 += j11;
                ...
                {
                    int j23 = class5_8.anInt240;
                    int l24 = (class5_8.anInt241 - j23) / l21;
                    if(j < -anInt265)
                    {
                        j23 += (-anInt265 - j) * l24;
                        j = -anInt265;
        ...
        if(class2.aBoolean129)
        {
            for(i = anInt307; i < anInt308; i += byte0)
            {
                Class5 class5 = aClass5Array306[i];
                j = class5.anInt238 >> 8;
                int k4 = class5.anInt239 >> 8;
                int k6 = k4 - j;
                if(k6 <= 0)
                {
                    l2 += i2;
                ...
                {
                    int l7 = class5.anInt240;
                    int i9 = (class5.anInt241 - l7) / k6;
                    if(j < -anInt265)
                    {
                        l7 += (-anInt265 - j) * i9;
                        j = -anInt265;
        ...
        if(aBoolean254)
        {
            for(i = anInt307; i < anInt308; i += byte0)
            {
                Class5 class5_1 = aClass5Array306[i];
                j = class5_1.anInt238 >> 8;
                int i5 = class5_1.anInt239 >> 8;
                int l6 = i5 - j;
                if(l6 <= 0)
                {
                    l2 += i2;
                ...
                {
                    int i8 = class5_1.anInt240;
                    int j9 = (class5_1.anInt241 - i8) / l6;
                    if(j < -anInt265)
                    {
                        i8 += (-anInt265 - j) * j9;
                        j = -anInt265;
        ...
        for(i = anInt307; i < anInt308; i += byte0)
        {
            Class5 class5_2 = aClass5Array306[i];
            j = class5_2.anInt238 >> 8;
            int k5 = class5_2.anInt239 >> 8;
            int i7 = k5 - j;
            if(i7 <= 0)
            {
                l2 += i2;
            ...
            {
                int j8 = class5_2.anInt240;
                int k9 = (class5_2.anInt241 - j8) / i7;
                if(j < -anInt265)
                {
                    j8 += (-anInt265 - j) * k9;
                    j = -anInt265;
    ...
    {
        Class4 class4 = aClass4Array282[i];
        Class2 class2 = class4.aClass2_227;
        int j = class4.anInt228;
        int ai[] = class2.anIntArrayArray109[j];
        int k = class2.anIntArray108[j];
        int l = class2.anIntArray113[j];
        int j1 = class2.anIntArray100[ai[0]];
        int k1 = class2.anIntArray101[ai[0]];
        int l1 = class2.anIntArray102[ai[0]];
        int i2 = class2.anIntArray100[ai[1]] - j1;
        int j2 = class2.anIntArray101[ai[1]] - k1;
        int k2 = class2.anIntArray102[ai[1]] - l1;
        int l2 = class2.anIntArray100[ai[2]] - j1;
        int i3 = class2.anIntArray101[ai[2]] - k1;
        int j3 = class2.anIntArray102[ai[2]] - l1;
        int k3 = j2 * j3 - i3 * k2;
        int l3 = k2 * l2 - j3 * i2;
        int i4 = i2 * i3 - l2 * j2;
        if(l == -1)
        {
            ...
            class2.anIntArray113[j] = l;
            class2.anIntArray112[j] = (int)((double)anInt270 * Math.sqrt(k3 * k3 + l3 * l3 + i4 * i4));
        } else
        {
            k3 >>= l;
            l3 >>= l;
        ...
        class4.anInt233 = j1 * k3 + k1 * l3 + l1 * i4;
        class4.anInt230 = k3;
        class4.anInt231 = l3;
        class4.anInt232 = i4;
        int j4 = class2.anIntArray102[ai[0]];
        int k4 = j4;
        int l4 = class2.anIntArray103[ai[0]];
        int i5 = l4;
        int j5 = class2.anIntArray104[ai[0]];
        int k5 = j5;
        for(int l5 = 1; l5 < k; l5++)
        {
            int i1 = class2.anIntArray102[ai[l5]];
            if(i1 > k4)
                k4 = i1;
            else
            if(i1 < j4)
                j4 = i1;
            i1 = class2.anIntArray103[ai[l5]];
            if(i1 > i5)
                i5 = i1;
            else
            if(i1 < l4)
                l4 = i1;
            i1 = class2.anIntArray104[ai[l5]];
            if(i1 > k5)
                k5 = i1;
            else
            if(i1 < j5)
    ...
    public void method290(int i)
    {
        ...
        int i1 = 0;
        int j1 = 1;
        int k1 = class2.anIntArray100[ai[0]];
        int l1 = class2.anIntArray101[ai[0]];
        int i2 = class2.anIntArray102[ai[0]];
        class2.anIntArray112[j] = 1;
        class2.anIntArray113[j] = 0;
        class4.anInt233 = k1 * l + l1 * i1 + i2 * j1;
        class4.anInt230 = l;
        class4.anInt231 = i1;
        class4.anInt232 = j1;
        int j2 = class2.anIntArray102[ai[0]];
        int k2 = j2;
        int l2 = class2.anIntArray103[ai[0]];
        int i3 = l2;
        if(class2.anIntArray103[ai[1]] < l2)
            l2 = class2.anIntArray103[ai[1]];
        else
            i3 = class2.anIntArray103[ai[1]];
        int j3 = class2.anIntArray104[ai[1]];
        int k3 = class2.anIntArray104[ai[0]];
        int k = class2.anIntArray102[ai[1]];
        if(k > k2)
            k2 = k;
        else
        if(k < j2)
            j2 = k;
        k = class2.anIntArray103[ai[1]];
        if(k > i3)
            i3 = k;
        else
        if(k < l2)
            l2 = k;
        k = class2.anIntArray104[ai[1]];
        if(k > k3)
            k3 = k;
        else
        if(k < j3)
        ...
        class4.anInt225 = j2;
        class4.anInt226 = k2;
        class4.anInt221 = l2 - 20;
        class4.anInt223 = i3 + 20;
        class4.anInt222 = j3;
        class4.anInt224 = k3;
    }

    public boolean method291(Class4 class4, Class4 class4_1)
    {
        if(class4.anInt221 >= class4_1.anInt223)
            return true;
        if(class4_1.anInt221 >= class4.anInt223)
            return true;
        if(class4.anInt222 >= class4_1.anInt224)
            return true;
        if(class4_1.anInt222 >= class4.anInt224)
            return true;
        if(class4.anInt225 >= class4_1.anInt226)
            return true;
        if(class4_1.anInt225 > class4.anInt226)
            return false;
        Class2 class2 = class4.aClass2_227;
        Class2 class2_1 = class4_1.aClass2_227;
        int i = class4.anInt228;
        int j = class4_1.anInt228;
        int ai[] = class2.anIntArrayArray109[i];
        int ai1[] = class2_1.anIntArrayArray109[j];
        int k = class2.anIntArray108[i];
        int l = class2_1.anIntArray108[j];
        int k2 = class2_1.anIntArray100[ai1[0]];
        int l2 = class2_1.anIntArray101[ai1[0]];
        int i3 = class2_1.anIntArray102[ai1[0]];
        int j3 = class4_1.anInt230;
        int k3 = class4_1.anInt231;
        int l3 = class4_1.anInt232;
        int i4 = class2_1.anIntArray112[j];
        int j4 = class4_1.anInt233;
        boolean flag = false;
        for(int k4 = 0; k4 < k; k4++)
        {
            int i1 = ai[k4];
            int i2 = (k2 - class2.anIntArray100[i1]) * j3 + (l2 - class2.anIntArray101[i1]) * k3 + (i3 - class2.anIntArray102[i1]) * l3;
        ...
        if(!flag)
            return true;
        k2 = class2.anIntArray100[ai[0]];
        l2 = class2.anIntArray101[ai[0]];
        i3 = class2.anIntArray102[ai[0]];
        j3 = class4.anInt230;
        k3 = class4.anInt231;
        l3 = class4.anInt232;
        i4 = class2.anIntArray112[i];
        j4 = class4.anInt233;
        flag = false;
        for(int l4 = 0; l4 < l; l4++)
        {
            int j1 = ai1[l4];
            int j2 = (k2 - class2_1.anIntArray100[j1]) * j3 + (l2 - class2_1.anIntArray101[j1]) * k3 + (i3 - class2_1.anIntArray102[j1]) * l3;
        ...
        if(k == 2)
        {
            ...
            int i5 = ai[0];
            int k1 = ai[1];
            ai2[0] = class2.anIntArray103[i5] - 20;
            ai2[1] = class2.anIntArray103[k1] - 20;
            ai2[2] = class2.anIntArray103[k1] + 20;
            ai2[3] = class2.anIntArray103[i5] + 20;
            ai3[0] = ai3[3] = class2.anIntArray104[i5];
            ai3[1] = ai3[2] = class2.anIntArray104[k1];
        } else
        {
            ai2 = new int[k];
            ai3 = new int[k];
            ...
            {
                int i6 = ai[j5];
                ai2[j5] = class2.anIntArray103[i6];
                ai3[j5] = class2.anIntArray104[i6];
            }
        ...
        if(l == 2)
        {
            ...
            int k5 = ai1[0];
            int l1 = ai1[1];
            ai4[0] = class2_1.anIntArray103[k5] - 20;
            ai4[1] = class2_1.anIntArray103[l1] - 20;
            ai4[2] = class2_1.anIntArray103[l1] + 20;
            ai4[3] = class2_1.anIntArray103[k5] + 20;
            ai5[0] = ai5[3] = class2_1.anIntArray104[k5];
            ai5[1] = ai5[2] = class2_1.anIntArray104[l1];
        } else
        {
            ai4 = new int[l];
            ai5 = new int[l];
            ...
            {
                int j6 = ai1[l5];
                ai4[l5] = class2_1.anIntArray103[j6];
                ai5[l5] = class2_1.anIntArray104[j6];
            }
    ...
    public boolean method292(Class4 class4, Class4 class4_1)
    {
        Class2 class2 = class4.aClass2_227;
        Class2 class2_1 = class4_1.aClass2_227;
        int i = class4.anInt228;
        ...
        int k = class2.anIntArray108[i];
        int l = class2_1.anIntArray108[j];
        int i2 = class2_1.anIntArray100[ai1[0]];
        int j2 = class2_1.anIntArray101[ai1[0]];
        int k2 = class2_1.anIntArray102[ai1[0]];
        int l2 = class4_1.anInt230;
        int i3 = class4_1.anInt231;
        int j3 = class4_1.anInt232;
        int k3 = class2_1.anIntArray112[j];
        int l3 = class4_1.anInt233;
        boolean flag = false;
        for(int i4 = 0; i4 < k; i4++)
        {
            int i1 = ai[i4];
            int k1 = (i2 - class2.anIntArray100[i1]) * l2 + (j2 - class2.anIntArray101[i1]) * i3 + (k2 - class2.anIntArray102[i1]) * j3;
        ...
        if(!flag)
            return true;
        i2 = class2.anIntArray100[ai[0]];
        j2 = class2.anIntArray101[ai[0]];
        k2 = class2.anIntArray102[ai[0]];
        l2 = class4.anInt230;
        i3 = class4.anInt231;
        j3 = class4.anInt232;
        k3 = class2.anIntArray112[i];
        l3 = class4.anInt233;
        flag = false;
        for(int j4 = 0; j4 < l; j4++)
        {
            int j1 = ai1[j4];
            int l1 = (i2 - class2_1.anIntArray100[j1]) * l2 + (j2 - class2_1.anIntArray101[j1]) * i3 + (k2 - class2_1.anIntArray102[j1]) * j3;
    ...
    public void method299(int i, int j, int k)
    {
        ...
        for(int l = 0; l < anInt277; l++)
            aClass2Array279[l].method185(i, j, k);
    ...
    public void method300(int i, int j, int k, int l, int i1)
    {
        ...
        for(int j1 = 0; j1 < anInt277; j1++)
            aClass2Array279[j1].method184(i, j, k, l, i1);
    ...
    public int anInt277;
    public int anInt278;
    public Class2 aClass2Array279[];
    public int anIntArray280[];
    public int anInt281;
    public Class4 aClass4Array282[];
    public int anInt283;
    ...
    public Class3 aClass3_304;
    public int anIntArray305[];
    public Class5 aClass5Array306[];
    public int anInt307;
    public int anInt308;
