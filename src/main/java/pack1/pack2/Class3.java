    ...
    implements ImageProducer, ImageObserver
{
    ...
    public Class3(int i, int j, int k, Component component)
    {
        aBoolean208 = false;
        aBoolean212 = false;
    ...
    {
        int k = Class11.method344(abyte0, 0);
        int l = Class11.method344(abyte1, k);
        k += 2;
        int i1 = Class11.method344(abyte1, k);
        k += 2;
        ...
        for(int i2 = i; i2 < i + j; i2++)
        {
            ...
            anIntArray197[i2] = Class11.method344(abyte1, k);
            k += 2;
            anIntArray198[i2] = Class11.method344(abyte1, k);
            k += 2;
            ...
            aBooleanArray203[i2] = false;
            if(anIntArray199[i2] != 0 || anIntArray200[i2] != 0)
