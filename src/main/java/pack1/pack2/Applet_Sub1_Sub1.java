...
//            Applet_Sub1, Class10_Sub1, Class3
...
public class Applet_Sub1_Sub1 extends Applet_Sub1
{
    ...
    public void method23(String s, String s1, boolean flag)
    {
        ...
        {
            aString612 = s;
            s = Class11.method350(s, 20);
            aString613 = s1;
            s1 = Class11.method350(s1, 20);
            if(s.trim().length() == 0)
            {
            ...
            if(flag)
                ...
                method40(aStringArray607[6], aStringArray607[7]);
            aClass10_Sub1_614 = new Class10_Sub1(method19(aString610, anInt611), this);
            aClass10_Sub1_614.anInt403 = anInt609;
            int i = aClass10_Sub1_614.method324();
            anInt629 = i;
            ...
            if(flag)
                aClass10_Sub1_614.method334(19, 712);
            else
                aClass10_Sub1_614.method334(0, 625);
            aClass10_Sub1_614.method328(anInt608);
            aClass10_Sub1_614.method328(j);
            aClass10_Sub1_614.method330(Class11.method353(s));
            aClass10_Sub1_614.method333(s1, i, aBigInteger627, aBigInteger628);
            aClass10_Sub1_614.method329(method22());
            aClass10_Sub1_614.method337();
            aClass10_Sub1_614.method318();
            int k = aClass10_Sub1_614.method318();
            k = aClass10_Sub1_614.method335(k, anIntArray631);
    ...
    {
        if(aClass10_Sub1_614 != null)
            try
            {
                aClass10_Sub1_614.method334(1, 325);
                aClass10_Sub1_614.method337();
            }
    ...
    public void method27(String s, String s1)
    {
        ...
        try
        {
            ...
            aClass10_Sub1_614.method334(2, 129);
            aClass10_Sub1_614.method328(anInt608);
            aClass10_Sub1_614.method330(Class11.method353(s));
            aClass10_Sub1_614.method328(j);
            aClass10_Sub1_614.method333(s1, i, aBigInteger627, aBigInteger628);
    ...
    public void method28()
    {
        ...
        if(aClass10_Sub1_614.method339())
            aLong617 = l;
        if(l - aLong617 > 5000L)
        {
            aLong617 = l;
            aClass10_Sub1_614.method334(5, 348);
            aClass10_Sub1_614.method336();
        }
        try
        {
            aClass10_Sub1_614.method338(20);
        }
        catch(IOException _ex)
        {
            method25();
        ...
        if(!method48())
            return;
        int i = aClass10_Sub1_614.method326(aByteArray615);
        if(i > 0)
    ...
    {
        i = aClass10_Sub1_614.method335(i, anIntArray631);
        if(i == 8)
        {
        ...
        if(i == 23)
        {
            anInt618 = Class11.method343(aByteArray615[1]);
            for(int k = 0; k < anInt618; k++)
            {
                aLongArray619[k] = Class11.method346(aByteArray615, 2 + k * 9);
                anIntArray620[k] = Class11.method343(aByteArray615[10 + k * 9]);
            }
        ...
        if(i == 24)
        {
            long l = Class11.method346(aByteArray615, 1);
            int j1 = aByteArray615[9] & 0xff;
            for(int k1 = 0; k1 < anInt618; k1++)
                if(aLongArray619[k1] == l)
                {
                    if(anIntArray620[k1] == 0 && j1 != 0)
                        method47("@pri@" + Class11.method354(l) + " has logged in");
                    if(anIntArray620[k1] != 0 && j1 == 0)
                        method47("@pri@" + Class11.method354(l) + " has logged out");
                    anIntArray620[k1] = j1;
                    j = 0;
                    method30();
                    return;
            ...
            anInt618++;
            method47("@pri@" + Class11.method354(l) + " has been added to your friends list");
            method30();
            return;
        }
        if(i == 26)
        {
            anInt621 = Class11.method343(aByteArray615[1]);
            for(int i1 = 0; i1 < anInt621; i1++)
                aLongArray622[i1] = Class11.method346(aByteArray615, 2 + i1 * 8);
        ...
        if(i == 28)
        {
            long l1 = Class11.method346(aByteArray615, 1);
            String s1 = Class12.method365(Class13.method390(aByteArray615, 9, j - 9));
            method47("@pri@" + Class11.method354(l1) + ": tells you " + s1);
            return;
        } else
        {
    ...
    public void method31(String s, String s1)
    {
        s = Class11.method350(s, 20);
        s1 = Class11.method350(s1, 20);
        aClass10_Sub1_614.method334(25, 551);
        aClass10_Sub1_614.method333(s + s1, anInt629, aBigInteger627, aBigInteger628);
        aClass10_Sub1_614.method336();
    }

    public void method32(int i, int j, int k, int l)
    {
        aClass10_Sub1_614.method334(31, 777);
        aClass10_Sub1_614.method327(i);
        aClass10_Sub1_614.method327(j);
        aClass10_Sub1_614.method327(k);
        aClass10_Sub1_614.method327(l);
        aClass10_Sub1_614.method336();
    }
    ...
    public void method33(String s)
    {
        ...
        aClass10_Sub1_614.method334(29, 101);
        aClass10_Sub1_614.method330(l);
        aClass10_Sub1_614.method336();
    ...
    {
        aClass10_Sub1_614.method334(30, 511);
        aClass10_Sub1_614.method330(l);
        aClass10_Sub1_614.method336();
        for(int i = 0; i < anInt621; i++)
            if(aLongArray622[i] == l)
    ...
    {
        aClass10_Sub1_614.method334(26, 622);
        aClass10_Sub1_614.method330(Class11.method353(s));
        aClass10_Sub1_614.method336();
    }
    ...
    {
        aClass10_Sub1_614.method334(27, 707);
        aClass10_Sub1_614.method330(l);
        aClass10_Sub1_614.method336();
        ...
        method47("@pri@" + Class11.method354(l) + " has been removed from your friends list");
    }

    public void method37(long l, byte abyte0[], int i)
    {
        aClass10_Sub1_614.method334(28, 185);
        aClass10_Sub1_614.method330(l);
        aClass10_Sub1_614.method332(abyte0, 0, i);
        aClass10_Sub1_614.method336();
    }

    public void method38(byte abyte0[], int i)
    {
        aClass10_Sub1_614.method334(3, 643);
        aClass10_Sub1_614.method332(abyte0, 0, i);
        aClass10_Sub1_614.method336();
    }
    ...
    {
        aClass10_Sub1_614.method334(7, 293);
        aClass10_Sub1_614.method331(s);
        aClass10_Sub1_614.method336();
    }
    ...
    public Class10_Sub1 aClass10_Sub1_614;
