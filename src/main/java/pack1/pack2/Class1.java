...
public class Class1
{
    ...
    public Class1(Class3 class3, int i)
    {
        anInt78 = -1;
        aBoolean92 = true;
        aClass3_53 = class3;
    ...
    {
        return Class3.method221((anInt95 * i) / 114, (anInt96 * j) / 114, (anInt97 * k) / 176);
    }
    ...
    public void method136()
    {
        for(int i = 0; i < anInt54; i++)
            if(aBooleanArray56[i])
                ...
                if(anIntArray67[i] == 1)
                    method138(i, anIntArray65[i] - aClass3_53.method258(aStringArray72[i], anIntArray71[i]) / 2, anIntArray66[i], aStringArray72[i], anIntArray71[i]);
                else
                if(anIntArray67[i] == 2)
                ...
                if(anIntArray67[i] == 5 || anIntArray67[i] == 6)
    ...
    {
        aClass3_53.method214(j, k, l, i1, 0xffffff);
        aClass3_53.method216(j, k, l, anInt88);
        aClass3_53.method217(j, k, i1, anInt88);
        aClass3_53.method216(j, (k + i1) - 1, l, anInt91);
        aClass3_53.method217((j + l) - 1, k, i1, anInt91);
        if(anIntArray62[i] == 1)
        {
            for(int j1 = 0; j1 < i1; j1++)
            {
                aClass3_53.method216(j + j1, k + j1, 1, 0);
                aClass3_53.method216((j + l) - 1 - j1, k + j1, 1, 0);
            }
    ...
    {
        int i1 = k + aClass3_53.method257(l) / 3;
    ...
    protected void method139(int i, int j, int k, String s, int l)
    {
        ...
        if(aBooleanArray64[i])
            ...
            i1 = 0;
        aClass3_53.method254(s, j, k, l, i1);
    }
    ...
    protected void method140(int i, int j, int k, int l, int i1, String s, int j1)
    {
        ...
        if(anIntArray67[i] == 6)
        {
            if(anInt76 == 1 && anInt74 >= j - l / 2 && anInt75 >= k - i1 / 2 && anInt74 <= j + l / 2 && anInt75 <= k + i1 / 2)
                anInt78 = i;
            j -= aClass3_53.method258(s, j1) / 2;
        }
        if(anInt78 == i)
            s = s + "*";
        int l1 = k + aClass3_53.method257(j1) / 3;
        method139(i, j, l1, s, j1);
    }

    public void method141(int i, int j, int k, int l)
    {
        aClass3_53.method207(i, j, i + k, j + l);
        aClass3_53.method213(i, j, k, l, anInt91, anInt88);
        if(aBoolean93)
        {
            for(int i1 = i - (j & 0x3f); i1 < i + k; i1 += 128)
            {
                for(int j1 = j - (j & 0x1f); j1 < j + l; j1 += 128)
                    aClass3_53.method231(i1, j1, 6 + anInt94, 128);

            }

        }
        aClass3_53.method216(i, j, k, anInt88);
        aClass3_53.method216(i + 1, j + 1, k - 2, anInt88);
        aClass3_53.method216(i + 2, j + 2, k - 4, anInt89);
        aClass3_53.method217(i, j, l, anInt88);
        aClass3_53.method217(i + 1, j + 1, l - 2, anInt88);
        aClass3_53.method217(i + 2, j + 2, l - 4, anInt89);
        aClass3_53.method216(i, (j + l) - 1, k, anInt91);
        aClass3_53.method216(i + 1, (j + l) - 2, k - 2, anInt91);
        aClass3_53.method216(i + 2, (j + l) - 3, k - 4, anInt90);
        aClass3_53.method217((i + k) - 1, j, l, anInt91);
        aClass3_53.method217((i + k) - 2, j + 1, l - 2, anInt91);
        aClass3_53.method217((i + k) - 3, j + 2, l - 4, anInt90);
        aClass3_53.method208();
    }

    public void method142(int i, int j, int k, int l)
    {
        aClass3_53.method214(i, j, k, l, 0);
        aClass3_53.method215(i, j, k, l, anInt85);
        aClass3_53.method215(i + 1, j + 1, k - 2, l - 2, anInt86);
        aClass3_53.method215(i + 2, j + 2, k - 4, l - 4, anInt87);
        aClass3_53.method229(i, j, 2 + anInt94);
        aClass3_53.method229((i + k) - 7, j, 3 + anInt94);
        aClass3_53.method229(i, (j + l) - 7, 4 + anInt94);
        aClass3_53.method229((i + k) - 7, (j + l) - 7, 5 + anInt94);
    }

    protected void method143(int i, int j, int k)
    {
        aClass3_53.method229(i, j, k);
    }

    protected void method144(int i, int j, int k)
    {
        aClass3_53.method216(i, j, k, 0);
    }

    protected void method145(int i, int j, int k, int l, int i1, int j1, String as[], 
            int k1, int l1)
    {
        int i2 = i1 / aClass3_53.method257(j1);
        if(l1 > k1 - i2)
            l1 = k1 - i2;
        if(l1 < 0)
            l1 = 0;
        ...
        int k2 = i1 - i2 * aClass3_53.method257(j1);
        int i3 = k + (aClass3_53.method257(j1) * 5) / 6 + k2 / 2;
        for(int k3 = l1; k3 < k1; k3++)
        {
            method139(i, j + 2, i3, as[k3], j1);
            i3 += aClass3_53.method257(j1) - anInt98;
            if(i3 >= k + i1)
                return;
        }
    ...
    {
        int k1 = (i + k) - 12;
        aClass3_53.method215(k1, j, 12, l, 0);
        aClass3_53.method229(k1 + 1, j + 1, anInt94);
        aClass3_53.method229(k1 + 1, (j + l) - 12, 1 + anInt94);
        aClass3_53.method216(k1, j + 13, 12, 0);
        aClass3_53.method216(k1, (j + l) - 13, 12, 0);
        aClass3_53.method213(k1 + 1, j + 14, 11, l - 27, anInt80, anInt81);
        aClass3_53.method214(k1 + 3, i1 + j + 14, 7, j1, anInt83);
        aClass3_53.method217(k1 + 2, i1 + j + 14, j1, anInt82);
        aClass3_53.method217(k1 + 2 + 8, i1 + j + 14, j1, anInt84);
    }
    ...
    protected void method147(int i, int j, int k, int l, String as[])
    {
        ...
        {
            i1 += aClass3_53.method258(as[k1], l);
            if(k1 < j1 - 1)
                i1 += aClass3_53.method258("  ", l);
        }

        int l1 = j - i1 / 2;
        int i2 = k + aClass3_53.method257(l) / 3;
        for(int j2 = 0; j2 < j1; j2++)
        {
            ...
            if(aBooleanArray64[i])
                ...
                k2 = 0;
            if(anInt74 >= l1 && anInt74 <= l1 + aClass3_53.method258(as[j2], l) && anInt75 <= i2 && anInt75 > i2 - aClass3_53.method257(l))
            {
                if(aBooleanArray64[i])
                    k2 = 0x808080;
                else
            ...
            if(anIntArray62[i] == j2)
                if(aBooleanArray64[i])
                    ...
                    k2 = 0xc00000;
            aClass3_53.method254(as[j2], l1, i2, l, k2);
            l1 += aClass3_53.method258(as[j2] + "  ", l);
        }
    ...
    {
        int i1 = as.length;
        int j1 = k - (aClass3_53.method257(l) * (i1 - 1)) / 2;
        for(int k1 = 0; k1 < i1; k1++)
        {
            ...
            if(aBooleanArray64[i])
                ...
                l1 = 0;
            int i2 = aClass3_53.method258(as[k1], l);
            if(anInt74 >= j - i2 / 2 && anInt74 <= j + i2 / 2 && anInt75 - 2 <= j1 && anInt75 - 2 > j1 - aClass3_53.method257(l))
            {
                if(aBooleanArray64[i])
                    l1 = 0x808080;
                else
            ...
            if(anIntArray62[i] == k1)
                if(aBooleanArray64[i])
                    ...
                    l1 = 0xc00000;
            aClass3_53.method254(as[k1], j - i2 / 2, j1, l, l1);
            j1 += aClass3_53.method257(l);
        }
            ...
            int k1, int l1)
    {
        ...
        for(int k3 = l1; k3 < k1; k3++)
        {
            ...
            if(aBooleanArray64[i])
                ...
                i4 = 0;
            if(anInt74 >= j + 2 && anInt74 <= j + 2 + aClass3_53.method258(as[k3], j1) && anInt75 - 2 <= i3 && anInt75 - 2 > i3 - aClass3_53.method257(j1))
            {
                if(aBooleanArray64[i])
                    i4 = 0x808080;
                else
            ...
            if(anIntArray62[i] == k3 && aBoolean92)
                i4 = 0xff0000;
            aClass3_53.method254(as[k3], j + 2, i3, j1, i4);
            i3 += aClass3_53.method257(j1);
            if(i3 >= k + i1)
                return;
        }
    ...
    {
        int l = aClass3_53.anIntArray197[k];
        int i1 = aClass3_53.anIntArray198[k];
