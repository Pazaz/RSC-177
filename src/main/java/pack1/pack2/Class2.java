...
public class Class2
{
    ...
    public Class2(int i, int j, boolean flag, boolean flag1, boolean flag2, boolean flag3, boolean flag4)
    {
        anInt119 = 1;
        aBoolean120 = true;
        aBoolean127 = true;
    ...
    public Class2(byte abyte0[], int i, boolean flag)
    {
        anInt119 = 1;
        aBoolean120 = true;
        aBoolean127 = true;
        ...
        anInt180 = 512;
        anInt181 = 32;
        int j = Class11.method344(abyte0, i);
        i += 2;
        int k = Class11.method344(abyte0, i);
        i += 2;
        method173(j, k);
        anIntArrayArray152 = new int[k][1];
        for(int l = 0; l < j; l++)
        {
            anIntArray145[l] = Class11.method347(abyte0, i);
            i += 2;
        }

        for(int i1 = 0; i1 < j; i1++)
        {
            anIntArray146[i1] = Class11.method347(abyte0, i);
            i += 2;
        }

        for(int j1 = 0; j1 < j; j1++)
        {
            anIntArray147[j1] = Class11.method347(abyte0, i);
            i += 2;
        }
        ...
        {
            anIntArray110[l1] = Class11.method347(abyte0, i);
            i += 2;
        ...
        {
            anIntArray111[i2] = Class11.method347(abyte0, i);
            i += 2;
        ...
        for(int l2 = 0; l2 < k; l2++)
        {
            ...
            for(int i3 = 0; i3 < anIntArray108[l2]; i3++)
                ...
                {
                    anIntArrayArray109[l2][i3] = Class11.method344(abyte0, i);
                    i += 2;
                }
    ...
    public Class2(String s)
    {
        ...
        try
        {
            java.io.InputStream inputstream = Class11.method340(s);
    ...
    public Class2(Class2 aclass2[], int i, boolean flag, boolean flag1, boolean flag2, boolean flag3)
    {
        anInt119 = 1;
        aBoolean120 = true;
        aBoolean127 = true;
    ...
    public Class2(Class2 aclass2[], int i)
    {
        anInt119 = 1;
        aBoolean120 = true;
        aBoolean127 = true;
    ...
    public void method177(Class2 aclass2[], int i, boolean flag)
    {
        int j = 0;
        int k = 0;
        for(int l = 0; l < i; l++)
        ...
        {
            Class2 class2 = aclass2[i1];
            class2.method201();
            anInt181 = class2.anInt181;
            anInt180 = class2.anInt180;
            anInt176 = class2.anInt176;
            anInt177 = class2.anInt177;
            anInt178 = class2.anInt178;
            anInt179 = class2.anInt179;
            for(int j1 = 0; j1 < class2.anInt107; j1++)
            {
                int ai[] = new int[class2.anIntArray108[j1]];
                int ai1[] = class2.anIntArrayArray109[j1];
                for(int k1 = 0; k1 < class2.anIntArray108[j1]; k1++)
                    ai[k1] = method178(class2.anIntArray145[ai1[k1]], class2.anIntArray146[ai1[k1]], class2.anIntArray147[ai1[k1]]);

                int l1 = method180(class2.anIntArray108[j1], ai, class2.anIntArray110[j1], class2.anIntArray111[j1]);
                anIntArray114[l1] = class2.anIntArray114[j1];
                anIntArray113[l1] = class2.anIntArray113[j1];
                anIntArray112[l1] = class2.anIntArray112[j1];
                if(flag)
                    if(i > 1)
                    {
                        anIntArrayArray152[l1] = new int[class2.anIntArrayArray152[j1].length + 1];
                        anIntArrayArray152[l1][0] = i1;
                        for(int i2 = 0; i2 < class2.anIntArrayArray152[j1].length; i2++)
                            anIntArrayArray152[l1][i2 + 1] = class2.anIntArrayArray152[j1][i2];

                    } else
                    {
                        anIntArrayArray152[l1] = new int[class2.anIntArrayArray152[j1].length];
                        for(int j2 = 0; j2 < class2.anIntArrayArray152[j1].length; j2++)
                            anIntArrayArray152[l1][j2] = class2.anIntArrayArray152[j1][j2];
    ...
    public Class2[] method181(int i, int j, int k, int l, int i1, int j1, int k1, 
            boolean flag)
    {
        method201();
        int ai[] = new int[j1];
        ...
        Class2 aclass2[] = new Class2[j1];
        for(int l2 = 0; l2 < j1; l2++)
        {
            if(ai[l2] > k1)
                ai[l2] = k1;
            aclass2[l2] = new Class2(ai[l2], ai1[l2], true, true, true, flag, true);
    ...
    public void method182(Class2 class2, int ai[], int i, int j)
    {
        int ai1[] = new int[i];
        for(int k = 0; k < i; k++)
        {
            int l = ai1[k] = class2.method178(anIntArray145[ai[k]], anIntArray146[ai[k]], anIntArray147[ai[k]]);
            class2.anIntArray105[l] = anIntArray105[ai[k]];
            class2.aByteArray106[l] = aByteArray106[ai[k]];
        }

        int i1 = class2.method180(i, ai1, anIntArray110[j], anIntArray111[j]);
        if(!class2.aBoolean136 && !aBoolean136)
            class2.anIntArray131[i1] = anIntArray131[j];
        class2.anIntArray114[i1] = anIntArray114[j];
        class2.anIntArray113[i1] = anIntArray113[j];
        class2.anIntArray112[i1] = anIntArray112[j];
    }
    ...
    public void method196()
    {
        ...
        for(int i = 0; i < anInt107; i++)
        {
            ...
            for(int j = 0; j < i1; j++)
            {
                ...
                if(anIntArray148[l] > k1)
                    k1 = anIntArray148[l];
                if(anIntArray149[l] < l1)
                    l1 = anIntArray149[l];
                else
                if(anIntArray149[l] > i2)
                    i2 = anIntArray149[l];
                if(anIntArray150[l] < j2)
                    j2 = anIntArray150[l];
                else
                if(anIntArray150[l] > k2)
                    k2 = anIntArray150[l];
            }
    ...
    {
        method199();
        if(anInt125 > Class6.anInt321 || anInt126 < Class6.anInt320 || anInt121 > Class6.anInt317 || anInt122 < Class6.anInt316 || anInt123 > Class6.anInt319 || anInt124 < Class6.anInt318)
        {
            aBoolean120 = false;
            return;
        }
    ...
    {
        Class2 aclass2[] = new Class2[1];
        aclass2[0] = this;
        Class2 class2 = new Class2(aclass2, 1);
        class2.anInt118 = anInt118;
        class2.aBoolean129 = aBoolean129;
        return class2;
    }

    public Class2 method203(boolean flag, boolean flag1, boolean flag2, boolean flag3)
    {
        Class2 aclass2[] = new Class2[1];
        aclass2[0] = this;
        Class2 class2 = new Class2(aclass2, 1, flag, flag1, flag2, flag3);
        class2.anInt118 = anInt118;
        return class2;
    }

    public void method204(Class2 class2)
    {
        anInt162 = class2.anInt162;
        anInt163 = class2.anInt163;
        anInt164 = class2.anInt164;
        anInt159 = class2.anInt159;
        anInt160 = class2.anInt160;
        anInt161 = class2.anInt161;
        method191();
        anInt119 = 1;
    }
