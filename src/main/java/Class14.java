...
public class Class14
{
    ...
    {
        int i = Class11.method344(aByteArray516, anInt518);
        anInt518 += 2;
        return i;
    }
    ...
    {
        int i = Class11.method345(aByteArray516, anInt518);
        anInt518 += 4;
        if(i > 0x5f5e0ff)
            i = 0x5f5e0ff - i;
        return i;
    ...
    {
        aByteArray515 = Class11.method357("string.dat", 0, abyte0);
        anInt517 = 0;
        aByteArray516 = Class11.method357("integer.dat", 0, abyte0);
        anInt518 = 0;
        anInt428 = method394();
