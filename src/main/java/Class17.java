...
public class Class17
{
    ...
    public Class17(Class6 class6, Class3 class3)
    {
        aBoolean565 = false;
        aBoolean566 = true;
        anInt569 = 750;
        ...
        aByteArrayArray578 = new byte[4][2304];
        aByteArrayArray579 = new byte[4][2304];
        aByteArrayArray580 = new byte[4][2304];
        aByteArrayArray581 = new byte[4][2304];
        aByteArrayArray582 = new byte[4][2304];
        aByteArrayArray583 = new byte[4][2304];
        anIntArrayArray584 = new int[4][2304];
        anInt585 = 96;
        anInt586 = 96;
        ...
        aBoolean592 = false;
        aClass2Array593 = new Class2[64];
        aClass2ArrayArray594 = new Class2[4][64];
        aClass2ArrayArray595 = new Class2[4][64];
        aClass6_568 = class6;
        aClass3_567 = class3;
        for(int i = 0; i < 64; i++)
            anIntArray572[i] = Class6.method301(255 - i * 4, 255 - (int)((double)i * 1.75D), 255 - i * 4);

        for(int j = 0; j < 64; j++)
            anIntArray572[j + 64] = Class6.method301(j * 3, 144, 0);

        for(int k = 0; k < 64; k++)
            anIntArray572[k + 128] = Class6.method301(192 - (int)((double)k * 1.5D), 144 - (int)((double)k * 1.5D), 0);

        for(int l = 0; l < 64; l++)
            anIntArray572[l + 192] = Class6.method301(96 - (int)((double)l * 1.5D), 48 + (int)((double)l * 1.5D), 0);
    ...
    public void method403(int i, int j, int k)
    {
        if(i < 0 || j < 0 || i >= anInt585 - 1 || j >= anInt586 - 1)
            return;
        if(Class14.anIntArray478[k] == 1 || Class14.anIntArray478[k] == 2)
        {
            int l = method418(i, j);
            int i1;
            int j1;
            if(l == 0 || l == 4)
            {
                i1 = Class14.anIntArray476[k];
                j1 = Class14.anIntArray477[k];
            } else
            {
                j1 = Class14.anIntArray476[k];
                i1 = Class14.anIntArray477[k];
            }
            for(int k1 = i; k1 < i + i1; k1++)
            {
                for(int l1 = j; l1 < j + j1; l1++)
                    if(Class14.anIntArray478[k] == 1)
    ...
    {
        Class2 class2 = aClass2Array593[i + j * 8];
        for(int j1 = 0; j1 < class2.anInt99; j1++)
            if(class2.anIntArray145[j1] == k * 128 && class2.anIntArray147[j1] == l * 128)
            {
                class2.method186(j1, i1);
                return;
            }
    ...
    public int method414(int i, int j, int k)
    {
        ...
        if(l == 0)
            return -1;
        int i1 = Class14.anIntArray495[l - 1];
        return i1 != 2 ? 0 : 1;
    }
    ...
    public int method415(int i, int j, int k, int l)
    {
        ...
        if(i1 == 0)
            ...
            return Class14.anIntArray494[i1 - 1];
    }
    ...
    public void method423(int i, int j, int k, int l)
    {
        ...
        try
        {
            ...
            {
                byte abyte0[] = Class11.method357(s + ".hei", 0, aByteArray573);
                if(abyte0 == null && aByteArray575 != null)
                    abyte0 = Class11.method357(s + ".hei", 0, aByteArray575);
                ...
                abyte0 = Class11.method357(s + ".dat", 0, aByteArray574);
                if(abyte0 == null && aByteArray576 != null)
                    abyte0 = Class11.method357(s + ".dat", 0, aByteArray576);
                if(abyte0 == null || abyte0.length == 0)
                ...
                abyte0 = Class11.method357(s + ".loc", 0, aByteArray574);
                if(abyte0 != null && abyte0.length > 0)
                {
                    int i2 = 0;
            ...
            } else
            {
                ...
                Class11.method341("../gamedata/maps/" + s + ".jm", abyte1, 20736);
                int j2 = 0;
                int i3 = 0;
    ...
    {
        if(aBoolean566)
            aClass6_568.method261();
        for(int i = 0; i < 64; i++)
        {
            aClass2Array593[i] = null;
            for(int j = 0; j < 4; j++)
                aClass2ArrayArray594[j][i] = null;

            for(int k = 0; k < 4; k++)
                aClass2ArrayArray595[k][i] = null;
        ...
        for(int i = 0; i < 96; i++)
        {
            for(int j = 0; j < 96; j++)
                if(method412(i, j, 0) == 250)
                    ...
                    if(j == 47 && method412(i, j + 1, 0) != 250 && method412(i, j + 1, 0) != 2)
                        method413(i, j, 9);
                    else
                        method413(i, j, 2);
    ...
    public void method427(int i, int j, int k, int l, int i1)
    {
        int j1 = i * 3;
        int k1 = j * 3;
        int l1 = aClass6_568.method298(l);
        int i2 = aClass6_568.method298(i1);
        l1 = l1 >> 1 & 0x7f7f7f;
        i2 = i2 >> 1 & 0x7f7f7f;
        if(k == 0)
        {
            aClass3_567.method216(j1, k1, 3, l1);
            aClass3_567.method216(j1, k1 + 1, 2, l1);
            aClass3_567.method216(j1, k1 + 2, 1, l1);
            aClass3_567.method216(j1 + 2, k1 + 1, 1, i2);
            aClass3_567.method216(j1 + 1, k1 + 2, 2, i2);
            return;
        }
        if(k == 1)
        {
            aClass3_567.method216(j1, k1, 3, i2);
            aClass3_567.method216(j1 + 1, k1 + 1, 2, i2);
            aClass3_567.method216(j1 + 2, k1 + 2, 1, i2);
            aClass3_567.method216(j1, k1 + 1, 1, l1);
            aClass3_567.method216(j1, k1 + 2, 2, l1);
        }
    }
    ...
    public void method428(int i, int j, int k, boolean flag)
    {
        ...
        method426();
        if(aClass2_596 == null)
            aClass2_596 = new Class2(anInt585 * anInt586 * 2 + 256, anInt585 * anInt586 * 2 + 256, true, true, false, false, true);
        if(flag)
        {
            aClass3_567.method210();
            ...
            for(int j2 = 0; j2 < 96; j2++)
            {
                for(int i3 = 0; i3 < 96; i3++)
                {
                    ...
                    if(method412(j2, i3, k) > 0 && Class14.anIntArray495[method412(j2, i3, k) - 1] == 4)
                        i4 = 0;
                    if(method412(j2 - 1, i3, k) > 0 && Class14.anIntArray495[method412(j2 - 1, i3, k) - 1] == 4)
                        i4 = 0;
                    if(method412(j2, i3 - 1, k) > 0 && Class14.anIntArray495[method412(j2, i3 - 1, k) - 1] == 4)
                        i4 = 0;
                    if(method412(j2 - 1, i3 - 1, k) > 0 && Class14.anIntArray495[method412(j2 - 1, i3 - 1, k) - 1] == 4)
                        i4 = 0;
                    int j5 = class2.method178(j2 * 128, i4, i3 * 128);
                    int j7 = (int)(Math.random() * 10D) - 5;
                    class2.method186(j5, j7);
                }
            ...
            for(int j3 = 0; j3 < 95; j3++)
            {
                for(int j4 = 0; j4 < 95; j4++)
                {
                    ...
                    if(method412(j3, j4, k) > 0)
                    {
                        ...
                        int l5 = Class14.anIntArray495[l16 - 1];
                        int i19 = method414(j3, j4, k);
                        k7 = i10 = Class14.anIntArray494[l16 - 1];
                        if(l5 == 4)
                        {
                            k7 = 1;
                            i10 = 1;
                        ...
                        if(l5 != 2 || method416(j3, j4) > 0 && method416(j3, j4) < 24000)
                        ...
                        if(Class14.anIntArray496[l16 - 1] != 0)
                            anIntArrayArray590[j3][j4] |= 0x40;
                        if(Class14.anIntArray495[l16 - 1] == 2)
                    ...
                    if(k7 != i10 || i17 != 0)
                    {
                        ...
                        if(l14 == 0)
                        {
                            if(k7 != 0xbc614e)
                            {
                                ...
                                int l21 = class2.method180(3, ai, 0xbc614e, k7);
                                anIntArray587[l21] = j3;
                                anIntArray588[l21] = j4;
                                class2.anIntArray131[l21] = 0x30d40 + l21;
                            }
                            if(i10 != 0xbc614e)
                            {
                                ...
                                int i22 = class2.method180(3, ai7, 0xbc614e, i10);
                                anIntArray587[i22] = j3;
                                anIntArray588[i22] = j4;
                                class2.anIntArray131[i22] = 0x30d40 + i22;
                            }
                        } else
                        {
                            if(k7 != 0xbc614e)
                            {
                                ...
                                ai[2] = j4 + j3 * anInt585;
                                int j22 = class2.method180(3, ai, 0xbc614e, k7);
                                anIntArray587[j22] = j3;
                                anIntArray588[j22] = j4;
                                class2.anIntArray131[j22] = 0x30d40 + j22;
                            }
                            if(i10 != 0xbc614e)
                            {
                                ...
                                int k22 = class2.method180(3, ai7, 0xbc614e, i10);
                                anIntArray587[k22] = j3;
                                anIntArray588[k22] = j4;
                                class2.anIntArray131[k22] = 0x30d40 + k22;
                            }
                        }
                    } else
                    if(k7 != 0xbc614e)
                    {
                        ...
                        int l19 = class2.method180(4, ai1, 0xbc614e, k7);
                        anIntArray587[l19] = j3;
                        anIntArray588[l19] = j4;
                        class2.anIntArray131[l19] = 0x30d40 + l19;
                    }
                }
            ...
            for(int k4 = 1; k4 < 95; k4++)
            {
                for(int i6 = 1; i6 < 95; i6++)
                    if(method412(k4, i6, k) > 0 && Class14.anIntArray495[method412(k4, i6, k) - 1] == 4)
                    {
                        int l7 = Class14.anIntArray494[method412(k4, i6, k) - 1];
                        int j10 = class2.method178(k4 * 128, -method410(k4, i6), i6 * 128);
                        int l12 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6), i6 * 128);
                        int i15 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6 + 1), (i6 + 1) * 128);
                        int j17 = class2.method178(k4 * 128, -method410(k4, i6 + 1), (i6 + 1) * 128);
                        int ai2[] = {
                            j10, l12, i15, j17
                        };
                        int i20 = class2.method180(4, ai2, l7, 0xbc614e);
                        anIntArray587[i20] = k4;
                        anIntArray588[i20] = i6;
                        class2.anIntArray131[i20] = 0x30d40 + i20;
                        method427(k4, i6, 0, l7, l7);
                    } else
                    if(method412(k4, i6, k) == 0 || Class14.anIntArray495[method412(k4, i6, k) - 1] != 3)
                    {
                        if(method412(k4, i6 + 1, k) > 0 && Class14.anIntArray495[method412(k4, i6 + 1, k) - 1] == 4)
                        {
                            int i8 = Class14.anIntArray494[method412(k4, i6 + 1, k) - 1];
                            int k10 = class2.method178(k4 * 128, -method410(k4, i6), i6 * 128);
                            int i13 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6), i6 * 128);
                            int j15 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6 + 1), (i6 + 1) * 128);
                            int k17 = class2.method178(k4 * 128, -method410(k4, i6 + 1), (i6 + 1) * 128);
                            int ai3[] = {
                                k10, i13, j15, k17
                            };
                            int j20 = class2.method180(4, ai3, i8, 0xbc614e);
                            anIntArray587[j20] = k4;
                            anIntArray588[j20] = i6;
                            class2.anIntArray131[j20] = 0x30d40 + j20;
                            method427(k4, i6, 0, i8, i8);
                        }
                        if(method412(k4, i6 - 1, k) > 0 && Class14.anIntArray495[method412(k4, i6 - 1, k) - 1] == 4)
                        {
                            int j8 = Class14.anIntArray494[method412(k4, i6 - 1, k) - 1];
                            int l10 = class2.method178(k4 * 128, -method410(k4, i6), i6 * 128);
                            int j13 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6), i6 * 128);
                            int k15 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6 + 1), (i6 + 1) * 128);
                            int l17 = class2.method178(k4 * 128, -method410(k4, i6 + 1), (i6 + 1) * 128);
                            int ai4[] = {
                                l10, j13, k15, l17
                            };
                            int k20 = class2.method180(4, ai4, j8, 0xbc614e);
                            anIntArray587[k20] = k4;
                            anIntArray588[k20] = i6;
                            class2.anIntArray131[k20] = 0x30d40 + k20;
                            method427(k4, i6, 0, j8, j8);
                        }
                        if(method412(k4 + 1, i6, k) > 0 && Class14.anIntArray495[method412(k4 + 1, i6, k) - 1] == 4)
                        {
                            int k8 = Class14.anIntArray494[method412(k4 + 1, i6, k) - 1];
                            int i11 = class2.method178(k4 * 128, -method410(k4, i6), i6 * 128);
                            int k13 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6), i6 * 128);
                            int l15 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6 + 1), (i6 + 1) * 128);
                            int i18 = class2.method178(k4 * 128, -method410(k4, i6 + 1), (i6 + 1) * 128);
                            int ai5[] = {
                                i11, k13, l15, i18
                            };
                            int l20 = class2.method180(4, ai5, k8, 0xbc614e);
                            anIntArray587[l20] = k4;
                            anIntArray588[l20] = i6;
                            class2.anIntArray131[l20] = 0x30d40 + l20;
                            method427(k4, i6, 0, k8, k8);
                        }
                        if(method412(k4 - 1, i6, k) > 0 && Class14.anIntArray495[method412(k4 - 1, i6, k) - 1] == 4)
                        {
                            int l8 = Class14.anIntArray494[method412(k4 - 1, i6, k) - 1];
                            int j11 = class2.method178(k4 * 128, -method410(k4, i6), i6 * 128);
                            int l13 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6), i6 * 128);
                            int i16 = class2.method178((k4 + 1) * 128, -method410(k4 + 1, i6 + 1), (i6 + 1) * 128);
                            int j18 = class2.method178(k4 * 128, -method410(k4, i6 + 1), (i6 + 1) * 128);
                            int ai6[] = {
                                j11, l13, i16, j18
                            };
                            int i21 = class2.method180(4, ai6, l8, 0xbc614e);
                            anIntArray587[i21] = k4;
                            anIntArray588[i21] = i6;
                            class2.anIntArray131[i21] = 0x30d40 + i21;
            ...
            class2.method183(true, 40, 48, -50, -10, -50);
            aClass2Array593 = aClass2_596.method181(0, 0, 1536, 1536, 8, 64, 233, false);
            for(int j6 = 0; j6 < 64; j6++)
                aClass6_568.method259(aClass2Array593[j6]);
        ...
        for(int i2 = 0; i2 < 95; i2++)
        {
            for(int k2 = 0; k2 < 95; k2++)
            {
                ...
                if(k3 > 0 && (Class14.anIntArray489[k3 - 1] == 0 || aBoolean565))
                {
                    method430(aClass2_596, k3 - 1, i2, k2, i2 + 1, k2);
                    if(flag && Class14.anIntArray488[k3 - 1] != 0)
                    {
                    ...
                    if(flag)
                        aClass3_567.method216(i2 * 3, k2 * 3, 3, k1);
                }
                k3 = method422(i2, k2);
                if(k3 > 0 && (Class14.anIntArray489[k3 - 1] == 0 || aBoolean565))
                {
                    method430(aClass2_596, k3 - 1, i2, k2, i2, k2 + 1);
                    if(flag && Class14.anIntArray488[k3 - 1] != 0)
                    {
                    ...
                    if(flag)
                        aClass3_567.method217(i2 * 3, k2 * 3, 3, k1);
                }
                k3 = method416(i2, k2);
                if(k3 > 0 && k3 < 12000 && (Class14.anIntArray489[k3 - 1] == 0 || aBoolean565))
                {
                    method430(aClass2_596, k3 - 1, i2, k2, i2 + 1, k2 + 1);
                    if(flag && Class14.anIntArray488[k3 - 1] != 0)
                        anIntArrayArray590[i2][k2] |= 0x20;
                    if(flag)
                    {
                        aClass3_567.method218(i2 * 3, k2 * 3, k1);
                        aClass3_567.method218(i2 * 3 + 1, k2 * 3 + 1, k1);
                        aClass3_567.method218(i2 * 3 + 2, k2 * 3 + 2, k1);
                    }
                }
                if(k3 > 12000 && k3 < 24000 && (Class14.anIntArray489[k3 - 12001] == 0 || aBoolean565))
                {
                    method430(aClass2_596, k3 - 12001, i2 + 1, k2, i2, k2 + 1);
                    if(flag && Class14.anIntArray488[k3 - 12001] != 0)
                        anIntArrayArray590[i2][k2] |= 0x10;
                    if(flag)
                    {
                        aClass3_567.method218(i2 * 3 + 2, k2 * 3, k1);
                        aClass3_567.method218(i2 * 3 + 1, k2 * 3 + 1, k1);
                        aClass3_567.method218(i2 * 3, k2 * 3 + 2, k1);
                    }
                }
            }
        ...
        if(flag)
            aClass3_567.method227(anInt569 - 1, 0, 0, 285, 285);
        aClass2_596.method183(false, 60, 24, -50, -10, -50);
        aClass2ArrayArray594[k] = aClass2_596.method181(0, 0, 1536, 1536, 8, 64, 338, true);
        for(int l2 = 0; l2 < 64; l2++)
            aClass6_568.method259(aClass2ArrayArray594[k][l2]);
        ...
        for(int i7 = 1; i7 < 95; i7++)
        {
            for(int k9 = 1; k9 < 95; k9++)
            {
                ...
                if(i12 > 0)
                {
                    ...
                    int j28 = Class14.anIntArray491[i12 - 1];
                    ...
                    if(!method419(k23, i24 + 1))
                        i27 += byte0;
                    i12 = Class14.anIntArray492[i12 - 1];
                    j27 = -j27;
                    k27 = -k27;
                    l27 = -l27;
                    i28 = -i28;
                    ...
                    {
                        int ai8[] = new int[3];
                        ai8[0] = aClass2_596.method178(l26, l27, i26);
                        ai8[1] = aClass2_596.method178(j26, i28, i27);
                        ai8[2] = aClass2_596.method178(k25, k27, k26);
                        aClass2_596.method180(3, ai8, i12, 0xbc614e);
                    } else
                    if(method416(i7, k9) > 12000 && method416(i7, k9) < 24000 && method417(i7 + 1, k9 + 1) == 0)
                    {
                        int ai9[] = new int[3];
                        ai9[0] = aClass2_596.method178(k24, j27, i25);
                        ai9[1] = aClass2_596.method178(k25, k27, k26);
                        ai9[2] = aClass2_596.method178(j26, i28, i27);
                        aClass2_596.method180(3, ai9, i12, 0xbc614e);
                    } else
                    if(method416(i7, k9) > 0 && method416(i7, k9) < 12000 && method417(i7 + 1, k9 - 1) == 0)
                    {
                        int ai10[] = new int[3];
                        ai10[0] = aClass2_596.method178(j26, i28, i27);
                        ai10[1] = aClass2_596.method178(k24, j27, i25);
                        ai10[2] = aClass2_596.method178(l26, l27, i26);
                        aClass2_596.method180(3, ai10, i12, 0xbc614e);
                    } else
                    if(method416(i7, k9) > 0 && method416(i7, k9) < 12000 && method417(i7 - 1, k9 + 1) == 0)
                    {
                        int ai11[] = new int[3];
                        ai11[0] = aClass2_596.method178(k25, k27, k26);
                        ai11[1] = aClass2_596.method178(l26, l27, i26);
                        ai11[2] = aClass2_596.method178(k24, j27, i25);
                        aClass2_596.method180(3, ai11, i12, 0xbc614e);
                    } else
                    if(j27 == k27 && l27 == i28)
                    {
                        int ai12[] = new int[4];
                        ai12[0] = aClass2_596.method178(k24, j27, i25);
                        ai12[1] = aClass2_596.method178(k25, k27, k26);
                        ai12[2] = aClass2_596.method178(l26, l27, i26);
                        ai12[3] = aClass2_596.method178(j26, i28, i27);
                        aClass2_596.method180(4, ai12, i12, 0xbc614e);
                    } else
                    if(j27 == i28 && k27 == l27)
                    {
                        int ai13[] = new int[4];
                        ai13[0] = aClass2_596.method178(j26, i28, i27);
                        ai13[1] = aClass2_596.method178(k24, j27, i25);
                        ai13[2] = aClass2_596.method178(k25, k27, k26);
                        ai13[3] = aClass2_596.method178(l26, l27, i26);
                        aClass2_596.method180(4, ai13, i12, 0xbc614e);
                    } else
                    {
                        boolean flag1 = true;
                        ...
                        {
                            int ai14[] = new int[3];
                            ai14[0] = aClass2_596.method178(k25, k27, k26);
                            ai14[1] = aClass2_596.method178(l26, l27, i26);
                            ai14[2] = aClass2_596.method178(k24, j27, i25);
                            aClass2_596.method180(3, ai14, i12, 0xbc614e);
                            int ai16[] = new int[3];
                            ai16[0] = aClass2_596.method178(j26, i28, i27);
                            ai16[1] = aClass2_596.method178(k24, j27, i25);
                            ai16[2] = aClass2_596.method178(l26, l27, i26);
                            aClass2_596.method180(3, ai16, i12, 0xbc614e);
                        } else
                        {
                            int ai15[] = new int[3];
                            ai15[0] = aClass2_596.method178(k24, j27, i25);
                            ai15[1] = aClass2_596.method178(k25, k27, k26);
                            ai15[2] = aClass2_596.method178(j26, i28, i27);
                            aClass2_596.method180(3, ai15, i12, 0xbc614e);
                            int ai17[] = new int[3];
                            ai17[0] = aClass2_596.method178(l26, l27, i26);
                            ai17[1] = aClass2_596.method178(j26, i28, i27);
                            ai17[2] = aClass2_596.method178(k25, k27, k26);
                            aClass2_596.method180(3, ai17, i12, 0xbc614e);
                        }
                    }
                }
            }
        ...
        aClass2_596.method183(true, 50, 50, -50, -10, -50);
        aClass2ArrayArray595[k] = aClass2_596.method181(0, 0, 1536, 1536, 8, 64, 169, true);
        for(int l9 = 0; l9 < 64; l9++)
            aClass6_568.method259(aClass2ArrayArray595[k][l9]);

        if(aClass2ArrayArray595[k][0] == null)
    ...
    public void method429(Class2 aclass2[])
    {
        for(int i = 0; i < anInt585 - 2; i++)
        {
            for(int j = 0; j < anInt586 - 2; j++)
                if(method416(i, j) > 48000 && method416(i, j) < 60000)
                {
                    ...
                    method403(i, j, k);
                    Class2 class2 = aclass2[Class14.anIntArray475[k]].method203(false, true, false, false);
                    int k1 = ((i + i + i1) * 128) / 2;
                    int i2 = ((j + j + j1) * 128) / 2;
                    class2.method189(k1, -method409(k1, i2), i2);
                    class2.method188(0, method418(i, j) * 32, 0);
                    aClass6_568.method259(class2);
                    class2.method184(48, 48, -50, -10, -50);
                    if(i1 > 1 || j1 > 1)
                    {
    ...
    public void method430(Class2 class2, int i, int j, int k, int l, int i1)
    {
        method406(j, k, 40);
        method406(l, i1, 40);
        int j1 = Class14.anIntArray485[i];
        int k1 = Class14.anIntArray486[i];
        int l1 = Class14.anIntArray487[i];
        int i2 = j * 128;
        int j2 = k * 128;
        int k2 = l * 128;
        int l2 = i1 * 128;
        int i3 = class2.method178(i2, -anIntArrayArray591[j][k], j2);
        int j3 = class2.method178(i2, -anIntArrayArray591[j][k] - j1, j2);
        int k3 = class2.method178(k2, -anIntArrayArray591[l][i1] - j1, l2);
        int l3 = class2.method178(k2, -anIntArrayArray591[l][i1], l2);
        int ai[] = {
            i3, j3, k3, l3
        };
        int i4 = class2.method180(4, ai, k1, l1);
        if(Class14.anIntArray489[i] == 5)
        {
            class2.anIntArray131[i4] = 30000 + i;
            return;
        } else
        {
            class2.anIntArray131[i4] = 0;
            return;
        }
    }
    ...
    public Class3 aClass3_567;
    public Class6 aClass6_568;
    public int anInt569;
    ...
    public Class2 aClass2Array593[];
    public Class2 aClass2ArrayArray594[][];
    public Class2 aClass2ArrayArray595[][];
    public Class2 aClass2_596;
}
