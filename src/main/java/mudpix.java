...
public class mudpix extends pixmap {
    ...
    public void method244(int i, int j, int k, int l, int i1, int j1, int k1) {
        if (i1 >= 50000) {
            clinst.method86(i, j, k, l, i1 - 50000, j1, k1);
            return;
        }
        if (i1 >= 40000) {
            clinst.method87(i, j, k, l, i1 - 40000, j1, k1);
            return;
        }
        if (i1 >= 20000) {
            clinst.method88(i, j, k, l, i1 - 20000, j1, k1);
            return;
        }
        if (i1 >= 5000) {
            clinst.method89(i, j, k, l, i1 - 5000, j1, k1);
        } else {
            super.method230(i, j, k, l, i1);
        }
    }

    public mudclient clinst;
}
